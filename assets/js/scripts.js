...
$(function () {
    ...
    $('.topnav .menu-icon').on('click', function () {
        ...
        if (open) {
            ...
            logoChan.attr('src', 'assets/imgs/logo-dark.png');
            ...
            logoChan.attr('src', 'assets/imgs/logo-light.png');
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            tlogo.attr('src', 'assets/imgs/logo-dark.png');

        } else {

            tnavbar.removeClass("nav-scroll");
            tlogo.attr('src', 'assets/imgs/logo-light.png');
        }
    });
